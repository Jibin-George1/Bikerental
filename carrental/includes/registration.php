          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              ...
              <input type="file" id="img1" name="img1" accept=".jpg,.jpeg,.png" required="required" onchange="PreviewImage();"> <span style="color:red">Upload your profile photo</span>
                ...
                <div class="form-group">
                <span>Mobile No*</span>
                  <input pattern="[0-9]{10}" title="Enter the valid mobile number" class="form-control" name="mobileno" maxlength="10" placeholder="e.g-7236000339"  required="required">
                </div>
                <div class="form-group">
                <span>Email-id*</span>
